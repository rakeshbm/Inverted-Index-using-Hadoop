Created an Inverted Index of words occurring in a set of web pages on Google Cloud App Engine. The Hadoop's Mapper and Reducer classes were extended to build a map-reduction algorithm in Java.
